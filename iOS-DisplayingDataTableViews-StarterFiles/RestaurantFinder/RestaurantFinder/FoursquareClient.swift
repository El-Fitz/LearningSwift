	...
	enum VenueEndpoint: Endpoint {
		...
		var parameters: [String : AnyObject] {
			...
			case .Search(let clientID, let clientSecret, let coordinate, let category, let query, let searchRadius, let limit):
				...
				parameters[ParameterKeys.searchRadius] = searchRadius == nil ? DefaultValues.searchRadius : searchRadius
				parameters[ParameterKeys.limit] = limit == nil ? DefaultValues.limit : limit
				if query != nil {
